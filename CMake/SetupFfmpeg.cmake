...
externalproject_get_property(ffmpeg_ext SOURCE_DIR)
...
find_path(AVUTIL_INCLUDE_DIR libavutil/pixdesc.h
          PATHS               ${SOURCE_DIR}/include
          NO_DEFAULT_PATH)
if(${AVCODEC_INCLUDE_DIR-NOTFOUND})
set(AVCODEC_INCLUDE_DIR "")
endif()
if(${AVFORMAT_INCLUDE_DIR-NOTFOUND})
set(AVFORMAT_INCLUDE_DIR "")
endif()
if(${SWSCALE_INCLUDE_DIR-NOTFOUND})
set(SWSCALE_INCLUDE_DIR "")
endif()
...
find_library(AVCODEC_STATIC_LIBRARY avcodec
          PATHS               ${SOURCE_DIR}/lib
          NO_DEFAULT_PATH)
unset(AVUTIL_STATIC_LIBRARY CACHE)
find_library(AVFORMAT_STATIC_LIBRARY avformat
          PATHS               ${SOURCE_DIR}/lib
          NO_DEFAULT_PATH)
unset(AVUTIL_STATIC_LIBRARY CACHE)
find_library(SWSCALE_STATIC_LIBRARY swscale
          PATHS               ${SOURCE_DIR}/lib
          NO_DEFAULT_PATH)
unset(AVUTIL_STATIC_LIBRARY CACHE)
...
set(AVUTIL_STATIC_LIBRARY "")
endif()
if(${AVFORMAT_STATIC_LIBRARY-NOTFOUND})
set(AVFORMAT_STATIC_LIBRARY "")
endif()
if(${SWSCALE_STATIC_LIBRARY-NOTFOUND})
set(SWSCALE_STATIC_LIBRARY "")
endif()
if(${AVUTIL_STATIC_LIBRARY-NOTFOUND})
set(AVUTIL_STATIC_LIBRARY "")
endif()
